...
export default {
  ...
  methods: {
    send: function () {
      let url = 'https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=60e919407001d7a00adc7f4a8764a2d9&freeword=%E7%84%BC%E8%82%89'
      axios
        .get(url)
        .then((res) => { console.log( this.shops = res.data.rest) })
    }
  },
  data: function () {
    return {
